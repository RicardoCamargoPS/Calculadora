...
public class calculadoraMain extends JFrame {
	...
	public calculadoraMain() {
		...
		btnNewButton.setIcon(new ImageIcon(calculadoraMain.class.getResource("/icons/ponto.png")));
		
		JButton btnNewButton_1 = new JButton("");
		btnNewButton_1.setIcon(new ImageIcon(calculadoraMain.class.getResource("/icons/9021643_number_zero_bold_icon.png")));
		
		JButton btnNewButton_2 = new JButton("");
		btnNewButton_2.setIcon(new ImageIcon(calculadoraMain.class.getResource("/icons/sinal.png")));
		
		JButton btnNewButton_3 = new JButton("");
		btnNewButton_3.setIcon(new ImageIcon(calculadoraMain.class.getResource("/icons/1772613_calculate_eliminate_hide_minus_soustract_icon.png")));
		
		JButton btnNewButton_4 = new JButton("");
		btnNewButton_4.setIcon(new ImageIcon(calculadoraMain.class.getResource("/icons/9021520_number_one_bold_icon.png")));
		
		JButton btnNewButton_1_1 = new JButton("");
		btnNewButton_1_1.setIcon(new ImageIcon(calculadoraMain.class.getResource("/icons/9021688_number_two_bold_icon.png")));
		
		JButton btnNewButton_2_1 = new JButton("");
		btnNewButton_2_1.setIcon(new ImageIcon(calculadoraMain.class.getResource("/icons/9021548_number_three_bold_icon.png")));
		
		JButton btnNewButton_3_1 = new JButton("");
		btnNewButton_3_1.setIcon(new ImageIcon(calculadoraMain.class.getResource("/icons/1772614_calculate_calculator_divide_division_icon.png")));
		
		JButton btnNewButton_5 = new JButton("");
		btnNewButton_5.setIcon(new ImageIcon(calculadoraMain.class.getResource("/icons/9021575_number_four_bold_icon.png")));
		
		JButton btnNewButton_1_2 = new JButton("");
		btnNewButton_1_2.setIcon(new ImageIcon(calculadoraMain.class.getResource("/icons/9021519_number_five_bold_icon.png")));
		
		JButton btnNewButton_2_2 = new JButton("");
		btnNewButton_2_2.setIcon(new ImageIcon(calculadoraMain.class.getResource("/icons/9021657_number_six_bold_icon.png")));
		...
		btnNewButton_3_2.setIcon(new ImageIcon(calculadoraMain.class.getResource("/icons/1772631_add_addition_addition sign_calculator_math_icon.png")));
		
		JButton btnNewButton_6 = new JButton("");
		btnNewButton_6.setIcon(new ImageIcon(calculadoraMain.class.getResource("/icons/9021556_number_seven_bold_icon.png")));
		
		JButton btnNewButton_1_3 = new JButton("");
		btnNewButton_1_3.setIcon(new ImageIcon(calculadoraMain.class.getResource("/icons/9021606_number_eight_bold_icon.png")));
		
		JButton btnNewButton_2_3 = new JButton("");
		btnNewButton_2_3.setIcon(new ImageIcon(calculadoraMain.class.getResource("/icons/9021555_number_nine_bold_icon.png")));
		
		JButton btnNewButton_3_3 = new JButton("");
		btnNewButton_3_3.setVerticalAlignment(SwingConstants.TOP);
		btnNewButton_3_3.setIcon(new ImageIcon(calculadoraMain.class.getResource("/icons/1772632_calculator_math_multiplication_multiplication sign_multiply_icon.png")));
		
		JButton btnNewButton_3_3_1 = new JButton("");
		btnNewButton_3_3_1.setBackground(new Color(255, 0, 0));
		btnNewButton_3_3_1.setIcon(new ImageIcon(calculadoraMain.class.getResource("/icons/1772618_calculate_calculator_equal_equality_math_icon.png")));
		
		JButton btnNewButton_3_3_2 = new JButton("");
		btnNewButton_3_3_2.setIcon(new ImageIcon(calculadoraMain.class.getResource("/icons/ce.png")));
		
		JButton btnNewButton_3_3_3 = new JButton("");
		btnNewButton_3_3_3.setIcon(new ImageIcon(calculadoraMain.class.getResource("/icons/7238492_business_calculator_finance_financial_calculate_icon.png")));
		
		JButton btnNewButton_6_1 = new JButton("");
		btnNewButton_6_1.setIcon(new ImageIcon(calculadoraMain.class.getResource("/icons/1772620_calculator_left parenthese_math_parenthese_icon.png")));
		
		JButton btnNewButton_1_3_1 = new JButton("");
		btnNewButton_1_3_1.setIcon(new ImageIcon(calculadoraMain.class.getResource("/icons/1772626_calculator_math_parenthese_parenthese sign_right parenthese_icon.png")));
		
		JButton btnNewButton_2_3_1 = new JButton("");
		btnNewButton_2_3_1.setIcon(new ImageIcon(calculadoraMain.class.getResource("/icons/1772616_calculate_calculator_math_percentage_portion_icon.png")));
		
		JButton btnNewButton_3_3_3_1 = new JButton("");
		btnNewButton_3_3_3_1.setVerticalAlignment(SwingConstants.BOTTOM);
		btnNewButton_3_3_3_1.setIcon(new ImageIcon(calculadoraMain.class.getResource("/icons/y.png")));
		...
		btnNewButton_6_2.setIcon(new ImageIcon(calculadoraMain.class.getResource("/icons/1772617_calculation_calculator_math_pow_pow sign_icon.png")));
		
		JButton btnNewButton_1_3_2 = new JButton("");
		btnNewButton_1_3_2.setIcon(new ImageIcon(calculadoraMain.class.getResource("/icons/1772627_factorial_factorial sign_math_mathematics_x factorial_icon.png")));
		
		JButton btnNewButton_2_3_2 = new JButton("");
		btnNewButton_2_3_2.setIcon(new ImageIcon(calculadoraMain.class.getResource("/icons/1772619_calculator_math pi_mathematics_pi_pi sign_icon.png")));
		
		JButton btnNewButton_3_3_5 = new JButton("");
		btnNewButton_3_3_5.setIcon(new ImageIcon(calculadoraMain.class.getResource("/icons/1772628_calculate_calculation_math_square_square root_icon.png")));
		
		JButton btnNewButton_3_3_3_2 = new JButton("");
		btnNewButton_3_3_3_2.setVerticalAlignment(SwingConstants.BOTTOM);
		btnNewButton_3_3_3_2.setIcon(new ImageIcon(calculadoraMain.class.getResource("/icons/x.png")));
